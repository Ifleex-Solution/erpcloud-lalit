                            ...
                            <table class="table-bordered" id="invoiceTable">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="grandTotal" class="form-control text-right" name="grand_total_price" autocomplete="off" value="0.00" />
                                        </td>
                                    </tr>
                                    <tr></tr>
                                </tfoot>
        ...
        if (count == limits)
            ...
            if (mode === "+") {
                ...
                row1 = row1 + "<td><input type='text' name='discount_type[]' onkeyup='bdtask_invoice_quantitycalculate(" +
                    ...
                    "' /></td><td><input type='text' class='form-control text-right common_discount'  tabindex='" + tab7 + "' placeholder='0.00' min='0' onkeyup='bdtask_invoice_quantitycalculate(" + count + ",event);'  value='' name='discount[]' id='discount_" + count + "'  ></td><td><input type='text' name='discountvalue[]'  id='discount_value_" + count +
...
<script>
    ...
    function checkUser(event) {
        if (event.key === 'Enter') {
            if ($("#password").val() == "managernormal") {
                let item = arrItem.find(item => item.invoiceId == invoice_id);
